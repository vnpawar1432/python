...
if __name__=="__main__":
    shop = Shop("Nagendra Shop","Nagendra","MYCity",1000)
    print("Shop : "+shop.getShopName())
    print("Owner : "+shop.getOwnerName())
    print("City : "+shop.getCity())
    print("Zip : "+ str(shop.getPincode()))

    product1 = Products("car",123,720.50,710.20)
    product2 = Products("doll",124,920.50,880.20)
    product3 = Products("plane",125,1200.50,1100.20)
    product4 = Products("truck",126,980.50,930.20)
    ...
    print("Total Price : "+ str(shop.getProductTotalPrice()))
